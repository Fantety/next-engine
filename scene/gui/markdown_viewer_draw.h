...
public:
	...
	static void draw(MarkdownViewer &p_viewer, const MarkdownViewerLayout &p_layout, const MarkdownViewerLayoutTheme &p_theme, real_t p_scroll_offset, real_t p_table_horizontal_scroll_offset, const Vector<Rect2> &p_selection_rects = Vector<Rect2>());
};
