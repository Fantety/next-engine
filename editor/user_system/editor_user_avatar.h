...
class EditorUserAvatar : public HBoxContainer {
	...
	TextureRect *credits_icon = nullptr;
	...
	Label *details_credits_value = nullptr;
...
public:
	...
	static String format_credits(const String &p_credits);
	static String format_credits_value(const String &p_credits);
	...
	static String format_credits_for_test(const String &p_credits);
	static String format_credits_value_for_test(const String &p_credits);
