...
static constexpr const char *SYSTEM_PROMPT =
	...
	"scene.create_scene requires a res:// save path and saves the new scene after creation. scene.add_node and scene.delete_node save the current scene after a successful edit.\n"
