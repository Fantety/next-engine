...
void AIDocumentationService::_bind_methods() {
}

AIDocumentationService *AIDocumentationService::get_dispatcher_singleton() {
	static Ref<AIDocumentationService> dispatcher;
...
AIDocumentationResult AIDocumentationService::_dispatch_to_main_thread(MainThreadRequest &r_request) {
	return _dispatch_main_thread_request<AIDocumentationResult>(r_request, get_dispatcher_singleton(), &AIDocumentationService::_execute_request, request_mutex, "Failed to schedule documentation search on the main thread.");
}

void AIDocumentationService::_execute_request(uint64_t p_request_ptr) {
	_execute_request_ptr(reinterpret_cast<MainThreadRequest *>(p_request_ptr));
}

void AIDocumentationService::_execute_request_ptr(MainThreadRequest *p_request) {
...
AIDocumentationResult AIDocumentationService::_search_main_thread(const String &p_query, const String &p_class_name, const String &p_kind, int p_max_results, bool p_include_descriptions) const {
...
AIDocumentationResult AIDocumentationService::search(const String &p_query, const String &p_class_name, const String &p_kind, int p_max_results, bool p_include_descriptions) {
...
Array AIDocumentationService::get_writable_property_suggestions(Object *p_object, const String &p_property_path, int p_max_suggestions) {
	Array suggestions;
...
String AIDocumentationService::format_property_suggestions_for_error(Object *p_object, const String &p_object_label, const String &p_property_path, int p_max_suggestions) {
