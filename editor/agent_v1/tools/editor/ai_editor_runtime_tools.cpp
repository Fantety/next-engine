...
void _apply_tool_result(AIV1EditorToolResult &r_tool_result, const EditorRuntimeToolResult &p_result) {
...
String AIV1EditorRunSceneTool::get_name() const {
	return "editor.run_scene";
}

String AIV1EditorRunSceneTool::get_description() const {
	return "Runs a project scene through the Godot editor run bar. Supports main, current, and custom scene modes.";
}

Dictionary AIV1EditorRunSceneTool::get_parameters_schema() const {
	Dictionary schema;
	schema["type"] = "object";
...
AIV1EditorToolResult AIV1EditorRunSceneTool::execute_tool(const Dictionary &p_arguments) {
...
String AIV1EditorStopRunningSceneTool::get_name() const {
	return "editor.stop_running_scene";
}

String AIV1EditorStopRunningSceneTool::get_description() const {
	return "Stops the scene currently running from the Godot editor.";
}

Dictionary AIV1EditorStopRunningSceneTool::get_parameters_schema() const {
	Dictionary schema;
	schema["type"] = "object";
...
String AIV1EditorGetTerminalErrorsTool::get_name() const {
	return "editor.get_terminal_errors";
}

String AIV1EditorGetTerminalErrorsTool::get_description() const {
	return "Reads recent errors from the running scene debugger's terminal/error output.";
}

Dictionary AIV1EditorGetTerminalErrorsTool::get_parameters_schema() const {
	Dictionary schema;
	schema["type"] = "object";
...
AIV1EditorToolResult AIV1EditorGetTerminalErrorsTool::execute_tool(const Dictionary &p_arguments) {
	AIV1EditorToolResult result;
