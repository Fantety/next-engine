...
void AIV1SceneEditingService::_bind_methods() {
}

AIV1SceneEditingService *AIV1SceneEditingService::get_dispatcher_singleton() {
	static Ref<AIV1SceneEditingService> dispatcher;
...
AIV1SceneEditingResult AIV1SceneEditingService::_dispatch_to_main_thread(MainThreadRequest &r_request) {
	r_request.execution_context = AIV1ToolExecutionState::get_current();
	return _dispatch_main_thread_request<AIV1SceneEditingResult>(r_request, get_dispatcher_singleton(), &AIV1SceneEditingService::_execute_request, request_mutex, "Failed to schedule scene editing on the main thread.");
}

void AIV1SceneEditingService::_execute_request(uint64_t p_request_ptr) {
	_execute_request_ptr(reinterpret_cast<MainThreadRequest *>(p_request_ptr));
}

void AIV1SceneEditingService::_execute_request_ptr(MainThreadRequest *p_request) {
...
Node *AIV1SceneEditingService::_resolve_node_path(Node *p_scene_root, const String &p_path, bool p_allow_root, String &r_error) const {
	Node *node = AIV1EditorToolService::_resolve_node_path(p_scene_root, p_path, p_allow_root, r_error, true, "Node path was not found in the edited scene.");
...
Node *AIV1SceneEditingService::_instantiate_node(const String &p_type, String &r_error) const {
...
String AIV1SceneEditingService::_normalize_node_name(Node *p_parent, Node *p_node, const String &p_requested_name) const {
...
bool AIV1SceneEditingService::_normalize_scene_save_path(const String &p_path, String &r_path, String &r_error) const {
...
bool AIV1SceneEditingService::_get_current_scene_save_path_main_thread(Node *p_scene, String &r_path, String &r_error) const {
...
bool AIV1SceneEditingService::_ensure_scene_save_directory(const String &p_path, String &r_error) const {
...
bool AIV1SceneEditingService::_save_scene_main_thread(Node *p_scene, const String &p_path, String &r_saved_path, String &r_error) const {
	ERR_FAIL_NULL_V(p_scene, false);
...
bool AIV1SceneEditingService::_save_current_scene_main_thread(Node *p_scene, String &r_saved_path, String &r_error) const {
	ERR_FAIL_NULL_V(p_scene, false);
...
void AIV1SceneEditingService::_rollback_new_scene_main_thread(Node *p_scene) const {
...
bool AIV1SceneEditingService::_normalize_property_path(const String &p_property_path, Vector<StringName> &r_names, String &r_error) const {
...
bool AIV1SceneEditingService::_convert_array_typed_value(const Array &p_value, Variant::Type p_target_type, Variant &r_value, String &r_error) const {
	Array args = p_value;
...
Array AIV1SceneEditingService::_get_resource_hint_types(const String &p_hint_string) const {
	Array types;
...
bool AIV1SceneEditingService::_is_resource_type_allowed(const String &p_type, const String &p_hint_string) const {
	const String type = p_type.strip_edges();
	if (type.is_empty()) {
		return false;
	}
...
Ref<Resource> AIV1SceneEditingService::_instantiate_resource(const String &p_type, String &r_error) const {
	const String type = p_type.strip_edges();
	if (type.is_empty()) {
...
bool AIV1SceneEditingService::_apply_object_properties(Object *p_object, const Dictionary &p_properties, String &r_error) const {
...
bool AIV1SceneEditingService::_find_indexed_property_info(Object *p_object, const Vector<StringName> &p_names, PropertyInfo &r_property_info) const {
	ERR_FAIL_NULL_V(p_object, false);
	if (p_names.is_empty()) {
		return false;
	}
...
bool AIV1SceneEditingService::_convert_value_for_property(const Variant &p_value, const PropertyInfo *p_property_info, Variant::Type p_target_type, Variant &r_value, String &r_error) const {
...
bool AIV1SceneEditingService::_convert_dictionary_typed_value(const Dictionary &p_value, Variant::Type p_target_type, Variant &r_value, String &r_error) const {
...
bool AIV1SceneEditingService::_convert_value_for_target_type(const Variant &p_value, Variant::Type p_target_type, Variant &r_value, String &r_error) const {
...
bool AIV1SceneEditingService::_prepare_property_assignment(Object *p_object, const String &p_object_label, const String &p_property_path, const Variant &p_value, NodePath &r_property_path, Variant &r_current_value, Variant &r_converted_value, String &r_property_type, String &r_error) const {
	ERR_FAIL_NULL_V(p_object, false);
...
bool AIV1SceneEditingService::_apply_properties_direct(Node *p_node, const String &p_node_label, const Dictionary &p_properties, Array &r_applied_properties, String &r_error, String *r_failed_property_path) const {
...
bool AIV1SceneEditingService::_queue_properties_for_undo(EditorUndoRedoManager *p_undo_redo, Node *p_node, const String &p_node_label, const Dictionary &p_properties, Array &r_applied_properties, String &r_error, String *r_failed_property_path) const {
...
bool AIV1SceneEditingService::_set_indexed_property(Object *p_object, const String &p_property_path, const Variant &p_value, String &r_error) const {
	ERR_FAIL_NULL_V(p_object, false);
...
bool AIV1SceneEditingService::_node_tree_contains_scene_path(Node *p_node, const String &p_scene_path) const {
	ERR_FAIL_NULL_V(p_node, false);
...
bool AIV1SceneEditingService::_validate_patch_id(const String &p_id, String &r_error) const {
	if (p_id.is_empty()) {
		return true;
	}
...
Node *AIV1SceneEditingService::_resolve_patch_node(Node *p_scene_root, const String &p_locator, const HashMap<String, Node *> &p_created_nodes, bool p_allow_root, String &r_error) const {
...
bool AIV1SceneEditingService::_describe_node_tree(Node *p_scene_root, Node *p_node, int p_depth, int p_max_depth, int p_max_nodes, bool p_include_internal, Array &r_nodes, String &r_content) const {
...
String AIV1SceneEditingService::_preview_variant_value(const Variant &p_value) const {
	if (p_value.get_type() == Variant::NIL) {
		return "<null>";
	}
...
String AIV1SceneEditingService::_format_property_not_found_error(Object *p_object, const String &p_object_label, const String &p_property_path, const Vector<StringName> &p_property_names) const {
	...
	return vformat("Property `%s` was not found on `%s` (type `%s`).%s", p_property_path, p_object_label, p_object->get_class(), AIV1DocumentationService::format_property_suggestions_for_error(p_object, p_object_label, p_property_path));
}

bool AIV1SceneEditingService::_inspect_property_value(Node *p_node, const String &p_node_label, const String &p_property_path, Dictionary &r_property, String &r_error) const {
	ERR_FAIL_NULL_V(p_node, false);
	const String stripped_property_path = p_property_path.strip_edges();
	if (stripped_property_path.is_empty()) {
		r_error = "Property path is required.";
...
Array AIV1SceneEditingService::_get_default_inspection_property_paths(Node *p_node) const {
	Array paths;
...
Array AIV1SceneEditingService::_get_common_subproperty_paths(const String &p_property_path, Variant::Type p_type) const {
	Array paths;
	switch (p_type) {
		case Variant::VECTOR2:
		case Variant::VECTOR2I:
...
String AIV1SceneEditingService::_build_resource_value_example(const PropertyInfo &p_property_info) const {
...
void AIV1SceneEditingService::_select_node(Node *p_node) const {
...
AIV1SceneEditingResult AIV1SceneEditingService::_delete_node_main_thread(const String &p_node_path) {
	AIV1SceneEditingResult result;
	String error;
...
AIV1SceneEditingResult AIV1SceneEditingService::_list_properties_main_thread(const String &p_node_path, const String &p_filter, int p_max_properties, bool p_include_read_only, bool p_include_current_values) {
	AIV1SceneEditingResult result;
	String error;
	Node *scene = _get_edited_scene(error);
	if (!scene) {
...
AIV1SceneEditingResult AIV1SceneEditingService::_inspect_node_main_thread(const String &p_node_path, const Array &p_property_paths) {
	AIV1SceneEditingResult result;
	String error;
	Node *scene = _get_edited_scene(error);
	if (!scene) {
...
AIV1SceneEditingResult AIV1SceneEditingService::_describe_tree_main_thread(const String &p_root_path, int p_max_depth, int p_max_nodes, bool p_include_internal) {
	AIV1SceneEditingResult result;
	String error;
	Node *scene = _get_edited_scene(error);
	if (!scene) {
...
AIV1SceneEditingResult AIV1SceneEditingService::_apply_patch_main_thread(const Dictionary &p_patch) {
	AIV1SceneEditingResult result;
	Array applied_ops;
	...
	auto fail = [&](const String &p_error) -> AIV1SceneEditingResult {
		cleanup_pending();
...
AIV1SceneEditingResult AIV1SceneEditingService::delete_node(const String &p_node_path) {
...
AIV1SceneEditingResult AIV1SceneEditingService::list_properties(const String &p_node_path, const String &p_filter, int p_max_properties, bool p_include_read_only, bool p_include_current_values) {
	MainThreadRequest request;
...
AIV1SceneEditingResult AIV1SceneEditingService::inspect_node(const String &p_node_path, const Array &p_property_paths) {
	MainThreadRequest request;
...
AIV1SceneEditingResult AIV1SceneEditingService::describe_tree(const String &p_root_path, int p_max_depth, int p_max_nodes, bool p_include_internal) {
	MainThreadRequest request;
...
AIV1SceneEditingResult AIV1SceneEditingService::apply_patch(const Dictionary &p_patch) {
	MainThreadRequest request;
