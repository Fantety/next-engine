...
const char *AIV1RequirementFormTool::TOOL_NAME = "agent.collect_requirements";
...
String AIV1RequirementFormTool::get_name() const {
	return TOOL_NAME;
}

String AIV1RequirementFormTool::get_description() const {
...
Dictionary AIV1RequirementFormTool::get_parameters_schema() const {
	Dictionary schema;
	schema["type"] = "object";
...
AIV1EditorToolResult AIV1RequirementFormTool::execute_tool(const Dictionary &p_arguments) {
...
bool AIV1RequirementFormTool::is_requirement_form_tool(const String &p_tool_name) {
	return p_tool_name == TOOL_NAME;
}

AIV1EditorToolResult AIV1RequirementFormTool::make_submission_result(const Dictionary &p_form_arguments, const Dictionary &p_answers) {
	AIV1EditorToolResult result;
